...
from azure.identity import ManagedIdentityCredential, get_bearer_token_provider,InteractiveBrowserCredential,DefaultAzureCredential
...
def create_openai_client(
    ...
    if azure:
        ...
        tkn=get_bearer_token_provider(creds,cognitive_services_endpoint)
        r=AsyncAzureOpenAI(
            azure_ad_token_provider=tkn,
            # Azure-Specifics
        ...
        return AsyncAzureOpenAI(
            ...
            azure_ad_token_provider=get_bearer_token_provider(
                #ManagedIdentityCredential(client_id="295ce65c-28c6-4763-be6f-a5eb36c3ceb3")
                InteractiveBrowserCredential()
                #DefaultAzureCredential(managed_identity_client_id="295ce65c-28c6-4763-be6f-a5eb36c3ceb3", exclude_interactive_browser_credential = False)
